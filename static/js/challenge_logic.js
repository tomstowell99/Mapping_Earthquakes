...
d3.json("https://raw.githubusercontent.com/tomstowell99/Mapping_Earthquakes/main/tectonic.json").then(function(dataPlates) {
    //console.log(dataPlates);

    let platelayer = L.geoJson(dataPlates, {color: "#ea822c", weight: 3});
